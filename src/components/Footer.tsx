...
export function Footer() {
  ...
  return <footer className="bg-muted/30 border-t mt-auto">
        ...
        <div className="py-4 border-t border-border/40">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center space-x-3">
              <img src={indianDoodle} alt="Indian cultural artwork" className="h-6 w-auto opacity-60" />
            ...
            <div className="flex items-center space-x-3">
              ...
              return <a key={social.name} href={social.href} className="text-muted-foreground hover:text-foreground transition-colors" aria-label={social.name}>
