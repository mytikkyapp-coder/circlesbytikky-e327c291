...
export function LaunchOfferSignupPopup({ open, onOpenChange }: LaunchOfferSignupPopupProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[450px] p-0 bg-gradient-to-br from-background via-background to-primary/5 border-2 border-primary/20">
        {/* Header Section */}
        <div className="relative px-6 pt-6 pb-4 bg-gradient-to-r from-primary/10 to-secondary/10 border-b border-border/50">
          <button
        ...
        <div className="px-6 py-6">
          <div className="mb-6 p-4 bg-primary/5 rounded-lg border border-primary/20">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-semibold text-primary">What You Get:</span>
            </div>
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>• Pro plan access for 12 months</li>
              <li>• Save ₹5,398 on your subscription</li>
              <li>• Priority customer support</li>
              <li>• Advanced features unlock</li>
            </ul>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button 
              type="submit" 
              className="w-full h-12 bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-white font-semibold text-base mt-6"
